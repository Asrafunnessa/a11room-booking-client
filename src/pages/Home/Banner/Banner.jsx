    ...
    return (
        <div className="carousel w-full h-[600px]">
            <div id="slide1" className="carousel-item relative w-full">
                ...
                <div className="absolute rounded-xl flex items-center h-full left-0 top-0 bg-gradient-to-r from-[#151515] to-[rgba(21, 21, 21, 0)]">
                    <div className='text-white space-y-7 pl-12 w-1/2'>
                        <h2 className='text-6xl font-bold'>Welcome To Hotello</h2>
            ...
            <div id="slide2" className="carousel-item relative w-full">
                ...
                <div className="absolute rounded-xl flex items-center h-full left-0 top-0 bg-gradient-to-r from-[#151515] to-[rgba(21, 21, 21, 0)]">
                    <div className='text-white space-y-7 pl-12 w-1/2'>
                        <h2 className='text-6xl font-bold'>Book a Comfortable Room</h2>
                        <p>There Are Many Variations Of Passages Of Available,But The Majority Have Suffered Alteration in Some From</p>
                        <div>
                            <button className='btn btn-primary btn-outline mr-5'>Room Suits</button>
                        </div>
            ...
            <div id="slide3" className="carousel-item relative w-full">
                ...
                <div className="absolute rounded-xl flex items-center h-full left-0 top-0 bg-gradient-to-r from-[#151515] to-[rgba(21, 21, 21, 0)]">
                    <div className='text-white space-y-7 pl-12 w-1/2'>
                        <h2 className='text-6xl font-bold'>Premium Room Service</h2>
                        <p>There Are Many Variations Of Passages Of Available,But The Majority Have Suffered Alteration in Some From</p>
                        <div>
                            <button className='btn btn-primary btn-outline mr-5'>Room Suits</button>
                        </div>
            ...
            <div id="slide4" className="carousel-item relative w-full">
                ...
                <div className="absolute rounded-xl flex items-center h-full left-0 top-0 bg-gradient-to-r from-[#151515] to-[rgba(21, 21, 21, 0)]">
                    <div className='text-white space-y-7 pl-12 w-1/2'>
                        <h2 className='text-6xl font-bold'>Enjoy Your Stay in Our Hotel</h2>
                        <p>There Are Many Variations Of Passages Of Available,But The Majority Have Suffered Alteration in Some From</p>
                        <div>
                            <button className='btn btn-primary btn-outline mr-5'>Room Suits</button>
                        </div>
