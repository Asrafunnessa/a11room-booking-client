        ...
        <div className="hero min-h-screen bg-base-200">
            <div className="hero-content flex-col lg:flex-row">
                ...
                <div className='lg:w-1/2 space-y-5 p-4'>
                    ...
                    <p className="py-6">Class apent taciti sociosqu ad lent per conu bia nostraellus. praesent eget em ante.Class apent taciti sociosqu ad lent per conu bia nostraellus. praesent eget em ante.Class apent taciti sociosqu ad lent per conu bia nostraellus. praesent eget em ante.</p>
                    <p className='py-6'>Class apent taciti sociosqu ad lent per conu bia nostraellus.praesent eget em ante.</p>
